...
export const imageStylePropsNames = without(Object.keys(imageDefaultProps), 'acitionType', 'src')
export const shapeStylePropsNames = without(Object.keys(shapeDefaultProps), 'actionType', 'backgroundColor')
